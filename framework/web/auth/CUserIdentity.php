...
/**
 * CUserIdentity is a base class for representing identities that are authenticated based on a userName and a userPasswd.
 *
 * Derived classes should implement {@link authenticate} with the actual
 * authentication scheme (e.g. checking userName and userPasswd against a DB table).
 *
...
class CUserIdentity extends CBaseUserIdentity
{
	 ...
	 * @param string $userPasswd userPasswd
	 */
	public function __construct($userName,$userPasswd)
	{
	...
	/**
	 * Authenticates a user based on {@link userName} and {@link userPasswd}.
