...
interface IMemberIdentity
{
	 ...
	 * The information needed to authenticate the member
	 * are usually provided in the constructor.
	 * @return boolean whether authentication succeeds.
	 */
	public function authenticate();
	...
	public function getId();
	/**
	 * Returns the display name for the identity (e.g. membername).
	 * @return string the display name for the identity.
	 */
	public function getName();
	/**
	 * Returns the additional identity information that needs to be persistent during the member session.
	 * @return array additional identity information that needs to be persistent during the member session (excluding {@link id}).
	 */
	public function getPersistentStates();
}
